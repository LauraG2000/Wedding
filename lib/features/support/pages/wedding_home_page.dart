                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            ...
                            textAlign: TextAlign.center,
                            style:
                                (isDesktopOrTablet ? Theme.of(context).textTheme.displayLarge : Theme.of(context).textTheme.displayMedium)
                                    ?.copyWith(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    ...
                                    textAlign: TextAlign.center,
                                    style:
                                        (isDesktopOrTablet ? Theme.of(context).textTheme.bodyMedium : Theme.of(context).textTheme.bodySmall)
                                            ?.copyWith(
